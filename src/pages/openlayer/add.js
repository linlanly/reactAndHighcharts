 ...
 */
  ...
  function o(e, t, r) {
      return new Promise((n,s)=>{
          ...
          o.onerror = e=>s(e);
          const i = new Blob([e]);
          "dataUrl" === t && o.readAsDataURL(i),
          "text" === t && o.readAsText(i, r)
      }
      )
  }
  ...
  function(e) {
      e.open = "open",
      e.closed = "closed",
      e.leftOpenRightClosed = "leftOpenRightClosed",
      e.leftClosedRightOpen = "leftClosedRightOpen"
  }(e || (e = {})),
  function(e) {
      e.css = "css",
      e.js = "js",
  ...
  document.addEventListener("__APP_AGENT_HTTP_RESPONSE_LISTENER__", e=>{
      ...
      t.response.arrayBuffer = e.detail.response.arrayBuffer,
      a.emit("response", t)
  }
  );
  ...
  window.foxAgentCrossRequest = async function(e) {
      const t = e.headers["Content-Type"] || e.headers["content-type"] || e.headers["Content-type"] || "text/plain"
        ...
        , n = "file" !== r ? e.data : {
          __APP_AGENT_FILE_BODY__: !0,
          ...e.data || {},
          ...Object.fromEntries(await Promise.all(Object.entries(e.files || {}).map(async([e,t])=>Array.isArray(t) ? [e, await Promise.all(t.map(s))] : [e, t && await s(t)])))
      }
        , d = `${location.href}____${i++}`
        , u = a.on("response", async({id: t, response: r})=>{
          if (t === d) {
              if (r.error)
                  return e.error("", void 0, new Error(r.error.message)),
                  void u();
              const t = {
                  header: r.headers,
                  status: r.status,
              ...
              r.ok ? e.success(t.body, t.header, n) : e.error(t.statusText, t.header, n),
              u()
          }
      }
      )
